...
export default function ContactSection() {
  return (
    ...
    >
      <div className="mx-auto w-full max-w-296 rounded-[0.85rem] bg-ink p-[clamp(2rem,5vw,4rem)] text-white max-[760px]:p-6">
        <div>
          <p className="font-mono text-[0.64rem] tracking-[0.075em] text-[#9caeff] uppercase">
            07 · Contact
          </p>
          <h2
            className="mt-4 max-w-196 text-[clamp(2.8rem,5.8vw,5.7rem)] leading-[0.98] font-[520] tracking-[-0.065em] max-[760px]:text-[clamp(2.55rem,12.5vw,4rem)]"
            id="contact-title"
          >
        ...
        <a
          className="mt-[clamp(2.5rem,5vw,4rem)] inline-flex w-fit items-center gap-[0.8rem] border-b border-white/35 pb-[0.3rem] text-[clamp(1.1rem,2vw,1.65rem)] tracking-tight transition-colors hover:border-[#9caeff] hover:text-[#9caeff]"
        ...
        <footer className="mt-[clamp(2.5rem,5vw,4rem)] flex items-center justify-between gap-6 border-t border-white/15 pt-[1.1rem] font-mono text-[0.57rem] tracking-wider text-white/55 uppercase max-[760px]:flex-col max-[760px]:items-start">
          <p>© 2026 Harry Ruiz</p>
          <nav
