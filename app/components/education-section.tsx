        ...
        <div className="min-w-0">
          {education.map((item) => (
            <article
              ...
              key={item.degree}
            >
              <div className="relative aspect-square w-[4.5rem] max-[760px]:self-start max-[760px]:w-[3.75rem] max-[440px]:w-14">
                <Image
                  src="/logo-uprm.png"
              ...
              <div>
                ...
                <h3 className="mt-[0.55rem] max-w-[32rem] text-[clamp(1.45rem,2.5vw,2.25rem)] leading-[1.1] font-[590] tracking-[-0.035em]">
                  {item.degree}
                </h3>
                <a
                ...
                <p className="mt-4 max-w-[41rem] text-[0.84rem] leading-[1.6] text-muted">
                  {item.note}
                </p>
              </div>
            </article>
